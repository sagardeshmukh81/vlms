...
model_path = "C:\\Users\\infyuser\\Documents\\Learning\\Vision\\paligemma\\model"  # Replace with the path to your local model directory
model = PaliGemmaForConditionalGeneration.from_pretrained(model_path, torch_dtype=torch.bfloat16)
